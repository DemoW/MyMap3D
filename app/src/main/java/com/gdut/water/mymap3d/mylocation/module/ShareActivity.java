...
public class ShareActivity extends BaseActivity implements OnClickListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		BaseActivity.mToolbar.setTitle("短串分享");
...
//		sharedPreferencesUtil.init(this.getApplicationContext());
		//SharedPreferencesUtil.init(this.getApplicationContext());
...
//		START = SharedPreferencesUtil.getCurrentPoint();
//		END = SharedPreferencesUtil.getDestinyPoint();
//		POI_POINT = SharedPreferencesUtil.getCurrentPoint();
		START = sharedPreferencesUtil.getCurrentPoint();
		END = sharedPreferencesUtil.getDestinyPoint();
		POI_POINT =  sharedPreferencesUtil.getCurrentPoint();

		mAMap.moveCamera(CameraUpdateFactory.newCameraPosition(new CameraPosition(
				AMapUtil.convertToLatLng(START), 12, 30, 30)));
	}
	...
	public void onClick(View v) {
		...
		switch (viewID) {
		case R.id.share_poi: {
			String title = "我的POI位置点";
			String snippet = "您现在所处的位置";
